    ...
    return (
      <div>       
          ...
          <div className="wrapper" style={{marginTop: "3em"}}>
            <div className="text-wrap fw-bold" style={{width: "55%"}}>
              ...
              <p className="introText2">
                Societas is a website that creates a judgment-free zone for you to find
                other like-minded peers to make your passion project come true.
              </p>
            </div>

            <img src="../public/images/Surfer.png" alt="Surfer" style={{maxWidth: "30%", marginRight: "4em"}}/>
            
          </div>
            
          <div className="wrapper">
            <div className="image2-container">
              <img src="../public/images/Telescope.png" alt="Telescope" style={{maxWidth: "80%"}}/>
            </div>
          ...
          <div className="introButton-container">
            <button type="button" className="introButton">Let's Go!</button>
          </div>
      </div>
    )
